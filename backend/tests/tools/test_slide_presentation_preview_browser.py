...
def test_sidebar_runs_drafts_and_saved_html_without_raster_fetches(tmp_path):
    ...
    def route_request(route):
        ...
        if path == "/":
        ...
        elif path == "/api/v1/presentations/preview":
            data = route.request.post_data_json
            doc = playback.prepare_presentation_document(playback.prepare_preview_source(data['html']), mode="present", slide_index=data['slide_index'])
            ...
            route.fulfill(json={"html": DECK, "presentation_id": "saved", "file_id": "pptx", "slide_count": 2, "canvas_revision": 1, "render_revision": 0})
        else:
