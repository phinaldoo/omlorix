...
slide_presentation_schema = Sections(
    sections=[
        Section(
            title="LLM Models",
            description="Configure the model that creates and reviews presentations in one tool conversation.",
            ...
            fields=[
                FieldSchema(
                    ...
                    description="Presentation specialist model. Code Execution is always available but optional, regardless of the model's saved tools. Requires image input and tool calling.",
                    type="select",
                    options=[],
