function createSchemaSection(section, extraClasses = []) {
    const sectionEl = document.createElement('section');
    sectionEl.classList.add('settings-section', ...extraClasses);
...
function coerceAttributeLength(value) {
...
function applyFieldAttributesToControl(control, field) {
