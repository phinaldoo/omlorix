...
const OMLORIX_MODEL_ICON = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512" class="icon omlorix-model-icon" aria-hidden="true" focusable="false"><path d="M104.45 343.5A175 175 0 0 1 301.29 86.96m123.75 123.75A175 175 0 0 1 168.5 407.55" fill="none" stroke="currentColor" stroke-width="32" stroke-linecap="round"/><circle cx="379.74" cy="132.26" r="50" fill="currentColor"/></svg>';
let Icons = {
    ...
    omlorixModel: OMLORIX_MODEL_ICON,
    ...
    plugin: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6.67 2.5v3.33m6.66-3.33v3.33M4.17 5.83h11.66v3.34A5.83 5.83 0 0 1 4.17 9.17zM10 15v2.5"/></svg>',
...
Icons.palette = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 20 20\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.33\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\" focusable=\"false\"><path d=\"M10 2.667a7.333 7.333 0 0 0 0 14.666h.667a1.667 1.667 0 0 0 1.48-2.433c-.42-.807.16-1.9 1.073-1.9H14a3.333 3.333 0 0 0 3.333-3.333c0-3.867-3.333-7-7.333-7Z\"/><path d=\"M6.333 6.833h.01M10 5.5h.01M13.667 7.5h.01M5.333 10.833h.01\"/></svg>";
